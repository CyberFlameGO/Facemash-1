...
<head>
	...
	<title>Facemash - Show Face</title>
...
<table cellspacing="0" class="facemash">
	...
	<tr class="facemash">
		<td class="facemash">
			<p class="firstline">Want to see Face rating? It's very easy!</p>

			<p class="seconline">Just enter the link to Facebook profile!</p>
			...
			<form action="<c:url value="/showFace" />" method="post" name="startGameForm">
				<input type="text" name="facebookUrl" maxlength="200" size="140"
				       placeholder="https://www.facebook.com/nevadilla - The link to Facebook profile">
				<br /> <br />
				<a href="#" onclick="document.forms['startGameForm'].submit(); return false;">Show Face!</a>
			</form>
